  ...
  return (
    <div className='md:pt-[70px] lg:px-[165px] md:px-20 bg-veryDarkViolet flex flex-col md:flex-row md:pb-[71px] text-center md:text-left py-12'>
      ...
      <div className='text-white flex flex-col md:flex-row flex-1 justify-between lg:ml-64 md:ml-28 space-y-8 md:space-y-0'>
        ...
        <div>
          <h3 className='font-bold text-base tracking-tight mb-5'>Resources</h3>
          <div>
            <motion.ul className='space-y-2 text-base font-medium text-grayishViolet tracking-tighter'
              whileInView={{ y: [20, 0], opacity: [0, 1] }}
              transition={{ duration: 0.5, ease: 'easeInOut', delay: 0.1 }}
        ...
        <div>
          <h3 className='font-bold text-base tracking-tight mb-5'>Company</h3>
          <div>
            <motion.ul className='space-y-2 text-base font-medium text-grayishViolet tracking-tighter'
              whileInView={{ y: [20, 0], opacity: [0, 1] }}
              transition={{ duration: 0.5, ease: 'easeInOut', delay: 0.1 }}
        ...
        <motion.div className='flex space-x-6 mx-auto md:mx-0'
